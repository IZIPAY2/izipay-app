...
const serviceAccount = {
  ...
  "auth_uri": process.env.FIREBASE_AUTH_URI, // Берем из переменной Render
  "token_uri": process.env.FIREBASE_TOKEN_URI, // Берем из переменной Render
  "auth_provider_x509_cert_url": process.env.FIREBASE_AUTH_PROVIDER_CERT_URL, // Берем из переменной Render
  "client_x509_cert_url": process.env.FIREBASE_CLIENT_CERT_URL, // Берем из переменной Render
  "universe_domain": process.env.FIREBASE_UNIVERSE_DOMAIN // Добавили это поле
};
